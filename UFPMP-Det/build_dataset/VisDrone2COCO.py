...
image_root = '/home/huangyecheng/dataset/COCO/images/UAVtestdev'
root = '/home/huangyecheng/dataset/COCO/annotations/UAVtestdev/'
coco = {}
...
anno_id = 0
for key_id in ids:
    filename = root + id_to_name[key_id]
    anno = open(filename)
    recs = anno.readlines()
    image_id = key_id
    for rec in recs:
...
with open('/home/huangyecheng/dataset/COCO/annotations/instances_UAVtestdev.json', 'w') as f:
    json.dump(coco, f)
