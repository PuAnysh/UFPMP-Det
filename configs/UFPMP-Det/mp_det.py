...
data_root = '/home/huangyecheng_2019/dataset/COCO/'
...
test_pipeline = [
    ...
    dict(
        ...
        # img_scale=[(1333, 1333),(1666,1666),(2333,2333)],
        img_scale=(1333, 800),
        # img_scale=(2666, 2666),
        flip=True,
        transforms=[
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            # ann_file=data_root + '/annotations/instance_merge_UAVval_scale_v1.json',
            # img_prefix=data_root + '/images/strip_UAVval_scale_v1/',
    ...
    test=dict(
        ...
        ann_file=data_root + 'annotations/instances_UAVval.json',
        img_prefix=data_root + '/images/UAVval/',
        # ann_file=data_root + 'annotations/instances_UAVtestdev.json',
        # img_prefix=data_root + '/images/UAVtestdev/',
        pipeline=test_pipeline))
